...
<style>
  ...
  .taxa-img { width: 100%; height: 100px; object-fit: cover; border-radius: 6px; cursor: pointer; }
  ...
  for (current_region in regions) {
    ...
    if (nrow(region_data) > 0) {
      ...
      for (i in 1:nrow(region_data)) {
        ...
        cat(sprintf(
     '<div class="taxa-card">
<a href="%s" target="_blank"><img src="%s" class="taxa-img"></a>
<p class="taxa-info">
<strong class="taxa-title">%s</strong><br>
<span class="taxa-obs">%s Obs.</span>
</p>
</div>',
          img_url, img_src, row$nom_commun_qc, format(row$n, big.mark=" ")
        )
        )
      }
      # Clore la grille 
